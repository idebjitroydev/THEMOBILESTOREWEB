<%@ Page Title="All Employees" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="All-Employees.aspx.cs" Inherits="Admin_User_Management_All_Employees" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-right">
                                <a href="/Admin/User-Management/Add-Employee.aspx" class="btn btn-success">Add New Employee</a>
                            </p>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView ID="dgEmp" OnPageIndexChanging="dgStates_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="pagination-ys" runat="server" AllowPaging="true" PageSize="10" CssClass="table table-striped border-white" AutoGenerateColumns="false">
                            <Columns>
                                <%--<asp:BoundField DataField="ID" HeaderText="State ID" />--%>
                                <asp:BoundField DataField="Name" HeaderText="Employee Name" />
                                <asp:BoundField DataField="Phone" HeaderText="Employee Phone" />
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton runat="server" CssClass="btn btn-primary btn-xs" ID="btnEdit" OnClick="btnEdit_Click">Edit Employee</asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        Actions
                                    </HeaderTemplate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Type Reset to <strong>DELETE</strong> all Data From Employees
