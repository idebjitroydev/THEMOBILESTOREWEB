<%@ Page Title="All States" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="All-States.aspx.cs" Inherits="Admin_Location_Management_All_States" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-right">
                                <a href="/Admin/Location-Management/Add-State.aspx" class="btn btn-success">Add New State</a>
                            </p>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView ID="dgStates" OnPageIndexChanging="dgStates_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="pagination-ys" runat="server" AllowPaging="true" PageSize="10" CssClass="table table-striped border-white" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton runat="server" CssClass="btn btn-primary btn-xs" ID="btnEdit" OnClick="BtnEdit_Click">Edit State</asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        Actions
                                    </HeaderTemplate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Type Reset to <strong>DELETE</strong> all Data From States
