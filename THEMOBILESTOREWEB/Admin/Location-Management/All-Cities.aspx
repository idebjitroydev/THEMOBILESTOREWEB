<%@ Page Title="All Cities" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="All-Cities.aspx.cs" Inherits="Admin_Location_Management_All_Cities" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-right">
                                <a href="/Admin/Location-Management/Add-City.aspx" class="btn btn-success">Add New City</a>
                            </p>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView ID="dgCities" OnPageIndexChanging="dgCities_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="pagination-ys" runat="server" AllowPaging="true" PageSize="10" CssClass="table table-striped border-white" AutoGenerateColumns="false">
                            <Columns>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Type Reset to <strong>DELETE</strong> all Data From Cities
