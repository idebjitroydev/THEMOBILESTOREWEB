<%@ Page Title="Add New Product" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Add-Product.aspx.cs" Inherits="Admin_Product_Management_Add_Products" %>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small>
                                    ...
                                    <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="Product Name Exists" OnServerValidate="CustomValidator1_ServerValidate" ControlToValidate="txtName" SetFocusOnError="true" Display="Dynamic" ValidationGroup="sub" ForeColor="#ff5666" />
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <asp:Button ID="btnSave" OnClick="btnSave_Click" ValidationGroup="sub" runat="server" Text="Save Product" CssClass="btn btn-success" />
