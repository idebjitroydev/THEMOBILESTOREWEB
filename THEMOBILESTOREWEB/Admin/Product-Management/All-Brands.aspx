<%@ Page Title="View All Brands" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="All-Brands.aspx.cs" Inherits="Admin_Product_Management_All_Categories" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-right">
                                <a href="/Admin/Product-Management/Add-Brand.aspx" class="btn btn-success">Add New Brand</a>
                            </p>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView ID="dgBrands" OnPageIndexChanging="dgBrands_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="pagination-ys" runat="server" AllowPaging="true" PageSize="10" CssClass="table table-striped border-white" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton runat="server" CssClass="btn btn-primary btn-xs" ID="btnEdit" OnClick="btnEdit_Click">Edit Brand</asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        Actions
                                    </HeaderTemplate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Type Reset to <strong>DELETE</strong> all Data From Brands
