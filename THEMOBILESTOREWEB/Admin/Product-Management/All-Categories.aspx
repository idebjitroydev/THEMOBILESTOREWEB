<%@ Page Title="View All Categories" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="All-Categories.aspx.cs" Inherits="Admin_Product_Management_All_Categories" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-right">
                                <a href="/Admin/Product-Management/Add-Category.aspx" class="btn btn-success">Add New Category</a>
                            </p>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView ID="dgCats" OnPageIndexChanging="dgCats_PageIndexChanging" PagerSettings-Mode="NumericFirstLast" PagerStyle-CssClass="pagination-ys" runat="server" AllowPaging="true" PageSize="10" CssClass="table table-striped border-white" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton runat="server" CssClass="btn btn-primary btn-xs" ID="btnEdit" OnClick="btnEdit_Click">Edit Category</asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderTemplate>
                                        Actions
                                    </HeaderTemplate>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Type Reset to <strong>DELETE</strong> all Data From Categories
